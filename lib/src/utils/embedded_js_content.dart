...
/// embed doesn't call any DartCallbacks or interact in any way with the
...
///
/// Note2: If you use "mobileJs" and "webJs", don't use "js" too. Use only one of them.
///
...
class EmbeddedJsContent {
  ...
  const EmbeddedJsContent({
    ...
    this.webJs,
          ...
          (js != null || (mobileJs != null && webJs != null)),
